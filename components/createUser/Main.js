...
const Main = () => {
  ...
  const [createUser, { data: submitResponse, isLoading }] =
    useCreateUserMutation();

  const inputStyle =
    "border border-[#e2e5ec] outline-none focus:border-blue-300 placeholder:text-[#AFABC3] text-sm rounded-md w-full p-2.5 bg-white";
