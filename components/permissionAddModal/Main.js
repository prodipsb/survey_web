...
import { useCreatePermissionMutation } from "../../redux/features/pemission/permissionApi";

const PermissionAddModal = ({ setShowPopup }) => {
  const [name, setName] = useState(null);
  const [createPermission, { isSuccess, isLoading }] =
      ...
      <div className="h-[300px] w-[90%] md:w-[50%] lg:w-[30%] drop-shadow-lg bg-white rounded-md fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        >
          <div className="w-full p-3">
            <p className="text-[13px] mb-2 ml-1">Permission Name</p>
            <input
